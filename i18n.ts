...
const en = {
  ...
  passwordPolicy: "Password must be longer than 3 characters and include at least 1 uppercase letter, 1 number, and 1 symbol.",
  ...
  autoSearchFlight: "Auto-search by flight number + date",
  ...
  autoFillNoMatch: "No matching result found. Try another input.",
...
const zh: typeof en = {
  ...
  passwordPolicy: "密碼需超過 3 個字元，且至少包含 1 個大寫字母、1 個數字與 1 個符號。",
  ...
  autoFillNoMatch: "找不到符合的資料，請嘗試其他輸入。",
